...
public class Cat_contator extends Atk_sql {
    ...
    **/ 
    ...
    public com.ateikon.structure.Rec_cat_contator  setRec ( ResultSet rs) throws Exception {
    ...
    /****
        execute: cat_contator
    **/ 


    public int execute ( com.ateikon.structure.Rec_cat_contator astr) throws Exception {
    ...
    **/ 
    ...
    public int execute ( String     prname
        ...
        if (tot_rec != 1){
            ...
            throw new Exception("Errore Agg. cat_contator! ");
        }
    ...
    **/ 
    ...
    public int executeInsert( String     prname
        ...
        l_query   = "";
        l_query  += " insert into pgmr.cat_contator ( \n";
        l_query  += "             cdazie   \n";
        l_query  += "           , prname   \n";
        l_query  += "           , annoco   \n";
        l_query  += "           , nprogr   \n";
    ...
    */
    ...
    public long getNew_token( ) throws Exception{ 
        ...
        long ll_tk = f_tabkey.getTabkey( "cat_contator" );
