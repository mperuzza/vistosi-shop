...
public class Vist_scocl_cp_col extends Atk_sql {

    public Vist_scocl_cp_col() {
    ...
    **/ 
    ...
    public ResultSet getKey( String     tkclie
        ...
        if (cdvistccol.equals("")){ 
            l_query  += "  and cdvistccol is null  \n";
        }else { 
        ...
        if (cdvistccol.equals("")){ 
            ...
            pstm.setString    (ind, cdvistccol); ind += 1;
        } 
        if (dtinva == null){ 
        }else { 
    ...
    /****
        setRec: vist_scocl_cp_col
    **/ 


    public com.ateikon.structure.Rec_vist_scocl_cp_col  setRec ( ResultSet rs) throws Exception {

        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;

        com.ateikon.structure.Rec_vist_scocl_cp_col lstr = new com.ateikon.structure.Rec_vist_scocl_cp_col();

        if (rs == null) return lstr;
        if (rs.getObject("tkclie")!=null) lstr.tkclie = rs.getString    ("tkclie"); 
        if (rs.getObject("cdvistccol")!=null) lstr.cdvistccol = rs.getString    ("cdvistccol"); 
    ...
    /****
        preupdate: vist_scocl_cp_col

        sovrascrivere per impostare i controlli da effetuare prima dell'execute
    **/ 


    public int preupdate ( com.ateikon.structure.Rec_vist_scocl_cp_col astr) throws Exception {
        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;
    ...
    **/ 
    ...
    public int preupdate ( com.ateikon.structure.Rec_vist_scocl_cp_col astr, ResultSet rs) throws Exception {
        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;
    ...
    /****
        execute: vist_scocl_cp_col
    **/ 


    public int execute ( com.ateikon.structure.Rec_vist_scocl_cp_col astr) throws Exception {
        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;
        ResultSet         rs   = null;
        ...
        if (astr.cdvistccol.equals("")){ 
            ...
            pstm.setString    (ind, astr.cdvistccol); ind += 1;
        } 
        if (astr.dtinva == null){ 
        }else { 
        ...
        if (tot_rec != 1){
            ...
            throw new Exception("Errore Agg. vist_scocl_cp_col! ");
        }
        */ 
    ...
    /****
        executeInsert: vist_scocl_cp_col
    **/ 


    public int executeInsert( com.ateikon.structure.Rec_vist_scocl_cp_col astr) throws Exception {
        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;
        ResultSet         rs   = null;
        ...
        l_query   = "";
        l_query  += " insert into pgmr.vist_scocl_cp_col ( \n";
        l_query  += "             tkclie   \n";
        l_query  += "           , cdvistccol   \n";
        l_query  += "           , dtinva   \n";
        l_query  += "           , dtfval   \n";
    ...
    */
    ...
    public long getNew_token( ) throws Exception{ 
        ...
        long ll_tk = f_tabkey.getTabkey( "vist_scocl_cp_col" );
    ...
    /****
        executeUpdate: vist_scocl_cp_col
    **/ 


    public int executeUpdate( com.ateikon.structure.Rec_vist_scocl_cp_col astr ) throws Exception { 
        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;
        ResultSet         rs   = null;
        ...
        l_query   = "";
        l_query  += " update pgmr.vist_scocl_cp_col  \n";
        l_query  += "         set dtfval = ?  \n";
        l_query  += "           , sconto1 = ?  \n";
        l_query  += "           , sconto2 = ?  \n";
        l_query  += "           , sconto3 = ?  \n";
        ...
        this.cdvistccol = astr.cdvistccol; 
