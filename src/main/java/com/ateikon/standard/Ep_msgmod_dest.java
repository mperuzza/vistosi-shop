...
public class Ep_msgmod_dest extends Atk_sql {
    ...
    **/ 
    ...
    /****
        setRec: ep_msgmod_dest
    **/ 


    public com.ateikon.structure.Rec_ep_msgmod_dest  setRec ( ResultSet rs) throws Exception {

        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;

        com.ateikon.structure.Rec_ep_msgmod_dest lstr = new com.ateikon.structure.Rec_ep_msgmod_dest();
    ...
    /****
        preupdate: ep_msgmod_dest

        sovrascrivere per impostare i controlli da effetuare prima dell'execute
    **/ 


    public int preupdate ( com.ateikon.structure.Rec_ep_msgmod_dest astr) throws Exception {
        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;
    ...
    **/ 
    ...
    public int preupdate ( com.ateikon.structure.Rec_ep_msgmod_dest astr, ResultSet rs) throws Exception {
        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;
    ...
    /****
        execute: ep_msgmod_dest
    **/ 


    public int execute ( com.ateikon.structure.Rec_ep_msgmod_dest astr) throws Exception {
        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;
        ResultSet         rs   = null;
        ...
        if (tot_rec != 1){
            ...
            throw new Exception("Errore Agg. ep_msgmod_dest! ");
        }
        */ 
    ...
    /****
        executeInsert: ep_msgmod_dest
    **/ 


    public int executeInsert( com.ateikon.structure.Rec_ep_msgmod_dest astr) throws Exception {
        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;
        ResultSet         rs   = null;
        ...
        l_query   = "";
        l_query  += " insert into pgmr.ep_msgmod_dest ( \n";
        l_query  += "             tkmsgmod   \n";
        l_query  += "           , dest   \n";
        l_query  += "           , tipodest   \n";
        l_query  += "           , cdazie   \n";
    ...
    */
    ...
    public long getNew_token( ) throws Exception{ 
        ...
        long ll_tk = f_tabkey.getTabkey( "ep_msgmod_dest" );
    ...
    /****
        executeUpdate: ep_msgmod_dest
    **/ 


    public int executeUpdate( com.ateikon.structure.Rec_ep_msgmod_dest astr ) throws Exception { 
        int               ind = 0;
        int               tot_rec = 0;
        PreparedStatement pstm = null;
        ResultSet         rs   = null;
        ...
        l_query   = "";
        l_query  += " update pgmr.ep_msgmod_dest  \n";
        l_query  += "         set profil = ?  \n";
        l_query  += "           , dtulag = ?  \n";
        l_query  += "  where tkmsgmod = ? \n";
        l_query  += "    and dest = ? \n";
