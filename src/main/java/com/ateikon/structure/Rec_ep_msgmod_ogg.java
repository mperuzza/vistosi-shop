...
public class Rec_ep_msgmod_ogg extends Object {

    public Rec_ep_msgmod_ogg() {

        super();
    }

    public Rec_ep_msgmod_ogg( com.ateikon.common.Ep_msgmod_ogg obj_common_from
                       , com.ateikon.common.Ep_msgmod_ogg obj_common_to   ) {
    ...
    public Rec_ep_msgmod_ogg( com.ateikon.common.Ep_msgmod_ogg obj_common_to   ) {
    ...
    public com.ateikon.common.Ep_msgmod_ogg obj_common_from = null;
    public com.ateikon.common.Ep_msgmod_ogg obj_common_to   = null;


    public String seStesso = "Rec_ep_msgmod_ogg";
    ...
    **/ 
    ...
    public void copy_from(Rec_ep_msgmod_ogg astr) throws Exception{ 
    ...
    **/ 
    ...
    /****
        setResultSet_key: ep_msgmod_ogg
    **/ 
