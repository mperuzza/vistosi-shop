...
public class Rec_vist_scocl_cp_col extends Object {

    public Rec_vist_scocl_cp_col() {

        super();
    }

    public Rec_vist_scocl_cp_col( com.ateikon.common.Vist_scocl_cp_col obj_common_from
                       , com.ateikon.common.Vist_scocl_cp_col obj_common_to   ) {
    ...
    public Rec_vist_scocl_cp_col( com.ateikon.common.Vist_scocl_cp_col obj_common_to   ) {
    ...
    public com.ateikon.common.Vist_scocl_cp_col obj_common_from = null;
    public com.ateikon.common.Vist_scocl_cp_col obj_common_to   = null;


    public String seStesso = "Rec_vist_scocl_cp_col";
    ...
    **/ 
    ...
    public void copy_from(Rec_vist_scocl_cp_col astr) throws Exception{ 
    ...
    /****
        setResultSet: vist_scocl_cp_col
    **/ 
    ...
    public int setResultSet ( java.sql.ResultSet rs) throws Exception {
        ...
        if (rs.getObject("cdvistccol")!=null) this.cdvistccol = rs.getString    ("cdvistccol"); 
    ...
    /****
        setResultSet_key: vist_scocl_cp_col
    **/ 
    ...
    **/ 
    ...
    public void trim( ) throws Exception {
        ...
        this.cdvistccol = this.cdvistccol.trim(); 
    ...
    public void rtrim( ) throws Exception {
        ...
        this.cdvistccol = of_rtrim(this.cdvistccol); 
    ...
    /****
        ctrl_mindate(): vist_scocl_cp_col
    **/ 
    ...
    **/ 
    ...
    public void requestValues(javax.servlet.http.HttpServletRequest request) throws Exception{ 
        ...
        if (request.getParameterValues("cdvistccol")!=null) arr_cdvistccol = request.getParameterValues("cdvistccol");
    ...
    public String[] arr_cdvistccol = null; 
