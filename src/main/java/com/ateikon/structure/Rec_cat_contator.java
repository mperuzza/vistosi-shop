...
public class Rec_cat_contator extends Object {

    public Rec_cat_contator() {

        super();
    }


    public String seStesso = "Rec_cat_contator";
    ...
    **/ 
    ...
    public void trim( ) throws Exception {
        ...
        this.prname = this.prname.trim(); 
        this.annoco = this.annoco.trim(); 
