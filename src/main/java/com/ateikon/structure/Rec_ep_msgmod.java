...
public class Rec_ep_msgmod extends Object {

    public Rec_ep_msgmod() {

        super();
    }

    public Rec_ep_msgmod( com.ateikon.common.Ep_msgmod obj_common_from
                       , com.ateikon.common.Ep_msgmod obj_common_to   ) {
    ...
    public Rec_ep_msgmod( com.ateikon.common.Ep_msgmod obj_common_to   ) {
    ...
    public com.ateikon.common.Ep_msgmod obj_common_from = null;
    public com.ateikon.common.Ep_msgmod obj_common_to   = null;


    public String seStesso = "Rec_ep_msgmod";
    ...
    **/ 
    ...
    public void copy_from(Rec_ep_msgmod astr) throws Exception{ 
