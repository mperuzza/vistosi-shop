...
public class Rec_ep_msgmod_appl extends Object {

    public Rec_ep_msgmod_appl() {

        super();
    }

    public Rec_ep_msgmod_appl( com.ateikon.common.Ep_msgmod_appl obj_common_from
                       , com.ateikon.common.Ep_msgmod_appl obj_common_to   ) {
    ...
    public Rec_ep_msgmod_appl( com.ateikon.common.Ep_msgmod_appl obj_common_to   ) {
    ...
    public com.ateikon.common.Ep_msgmod_appl obj_common_from = null;
    public com.ateikon.common.Ep_msgmod_appl obj_common_to   = null;


    public String seStesso = "Rec_ep_msgmod_appl";
    ...
    **/ 
    ...
    public void copy_from(Rec_ep_msgmod_appl astr) throws Exception{ 

        this.cdmsgmod_appl = astr.cdmsgmod_appl;
        this.dsmsgmod_appl = astr.dsmsgmod_appl;
    ...
    **/ 
    ...
    public int setResultSet ( java.sql.ResultSet rs) throws Exception {
        ...
        if (rs.getObject("dsmsgmod_appl")!=null) this.dsmsgmod_appl = rs.getString    ("dsmsgmod_appl"); 
    ...
    /****
        setResultSet_key: ep_msgmod_appl
    **/ 
    ...
    **/ 
    ...
    public void trim( ) throws Exception {
        ...
        this.dsmsgmod_appl = this.dsmsgmod_appl.trim(); 
    ...
    public void rtrim( ) throws Exception {
        ...
        this.dsmsgmod_appl = of_rtrim(this.dsmsgmod_appl); 
    ...
    **/ 
    ...
    public void requestValues(javax.servlet.http.HttpServletRequest request) throws Exception{ 
        ...
        if (request.getParameterValues("dsmsgmod_appl")!=null) arr_dsmsgmod_appl = request.getParameterValues("dsmsgmod_appl");
    ...
    public String[] arr_dsmsgmod_appl = null; 
