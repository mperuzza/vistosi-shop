...
public class Str_totati_ord_test extends Object {

    public Str_totati_ord_test(){
    ...
    public String seStesso = "Str_totati_ord_test";
    ...
    public    double		totale_merce_normale             = 0;
