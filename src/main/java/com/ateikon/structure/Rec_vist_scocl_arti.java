...
public class Rec_vist_scocl_arti extends Object {

    public Rec_vist_scocl_arti() {

        super();
    }

    public Rec_vist_scocl_arti( com.ateikon.common.Vist_scocl_arti obj_common_from
                       , com.ateikon.common.Vist_scocl_arti obj_common_to   ) {
    ...
    public Rec_vist_scocl_arti( com.ateikon.common.Vist_scocl_arti obj_common_to   ) {
    ...
    public com.ateikon.common.Vist_scocl_arti obj_common_from = null;
    public com.ateikon.common.Vist_scocl_arti obj_common_to   = null;


    public String seStesso = "Rec_vist_scocl_arti";
    ...
    **/ 
    ...
    public void copy_from(Rec_vist_scocl_arti astr) throws Exception{ 
    ...
    **/ 
    ...
    /****
        setResultSet_key: vist_scocl_arti
    **/ 
    ...
    **/ 
    ...
    public void rtrim( ) throws Exception {
        ...
        this.cdarti = of_rtrim(this.cdarti); 
    ...
    **/ 
    ...
    public void requestValues(javax.servlet.http.HttpServletRequest request) throws Exception{ 
        ...
        if (request.getParameterValues("cdarti")!=null) arr_cdarti = request.getParameterValues("cdarti");
