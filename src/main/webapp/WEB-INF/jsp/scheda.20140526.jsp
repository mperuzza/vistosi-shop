                    ...
                    if(item[cd]!=null){
                        ...
                        switch (attr){
                            case 'vetro': 
                                ...
                                break;
                            case 'elettrificazioni':
                                cdico = item.cdvistelet + '.gif';
                                cdsel = item.cdvistelet;
                                break;
                            case 'finit_mont':
                            ...
                            if(scheda.articoli){
                                ...
                                var plu = (foundArt)?'<spring:message code="singular.m" text="o"/>':'<spring:message code="plural" text="i"/>';
                                    ...
                                    if(foundArt){
                                        ...
                                        if(scheda.etichette && scheda.etichette.length > 0){
                                            for(var x=0; x<scheda.etichette.length; x++ ){
                                        ...
                                        if(scheda.articolo!=null){
                                            ...
                                            var istrLabel = '<spring:message code="istruzioni_montaggio" text="Istruzioni di montaggio"/>';
                                            var m3DLabel  = '<spring:message code="modelli_3D" text="Modelli 3D"/>';
                                            var m2DLabel  = '<spring:message code="modelli_2D" text="Modelli 2D"/>';
                                            var dlink_class = '';
                                            ...
                                            <security:authorize ifAllGranted="ROLE_ANONYMOUS">
                                                ...
                                                var downloadUrl = '${eprogenUrl}epRichiesta_risorse_pubblica_form.jsp?';
                                                ...
                                                //&file_req=fileresources/techsheet/IM|SP|24PEA||||G9
                                            ...
                                            var tipo_richiesta, file, url;
                                            if(scheda.articolo.vist_articoli_img){
                                               
                                                tipo_richiesta = '&tipo_richiesta=' + (scheda.articolo.vist_articoli_img.pathschtecExists?'si_res':'no_res');
                                                file = '&file_req=fileresources/techsheet/'+scheda.articolo.vist_articoli_img.pathschtec;
                                                
                                                <security:authorize ifAllGranted="ROLE_ANONYMOUS">
                                                url = downloadUrl+ pars +tipo_richiesta + file + '&dsfile=' + istrLabel + ' ' + descrFile;
                                                </security:authorize>
                                                <security:authorize ifNotGranted="ROLE_ANONYMOUS">
                                                if(scheda.articolo.vist_articoli_img.pathschtecExists){
                                                    url = downloadUrl+ scheda.articolo.vist_articoli_img.pathschtec + '?f=fileresources/techsheet/' + scheda.articolo.vist_articoli_img.pathschtec;
                                                    dlink_class = '';
                                                }else{
                                                ...
                                                var ico = new Element('img', {src: (scheda.articolo.vist_articoli_img.pathschtecExists?'<c:url value="/static/images/pdf-icon.gif"/>':'<c:url value="/static/images/no-pdf-icon.gif"/>')});
                                                apdf.adopt(ico)
                                                $('file-dwl').adopt(apdf);
                                            }
                                            ...
                                            <security:authorize ifAllGranted="ROLE_ANONYMOUS">
                                            url = downloadUrl+ pars +tipo_richiesta + file + '&dsfile=' + m2DLabel + ' ' + descrFile;
                                            </security:authorize>
                                            <security:authorize ifNotGranted="ROLE_ANONYMOUS">
                                            if(scheda.articolo.model2D_dwgExists){
                                            ...
                                            if(scheda.articolo.cdartm!=null && (scheda.articolo.cdartm =='SPBAUTANVCRCR' 
                                                                                || scheda.articolo.cdartm =='LTNAXOS50' 
                                                                                || scheda.articolo.cdartm =='SPCLOTHGCMCR' 
                                                                                || scheda.articolo.cdartm =='LTNAXOS76' )){
                                                var apdf = new Element('a', {href: '<c:url value="/specsheet/"/>'+scheda.articolo.cdartm, 
                                                    target: '_blank',
                                                    title: 'specsheet',
                                                    'class': ''});
                                                    var ico = new Element('img', {src: '<c:url value="/static/images/icona-tech.png"/>'});
                                                    apdf.adopt(ico)
                                                    $('file-dwl').adopt(apdf);
                                            }
                                            ...
                                            $('file-dwl').getElements('a.downloadreqlink').each(function(item, index){
                                                item.addEvent('click', function(e){
                                                    ...
                                                    var jsonRequest = new Request.JSON({url: item.get('href'), onSuccess: function(data){
                                            ...
                                            if(scheda.articolo.certList.length>0){
                                                ...
                                                scheda.articolo.certList.each(function(el){
                                                    var apdf = new Element('a', {href: downloadUrl+ el.file + '?f=' + el.file, 
                                                    target: '_blank',
                                                    'class': dlink_class});
                                            ...
                                            if(scheda.techNewsList.length>0){ //modifico link solo se technews generica non c'era o se tk diverso
                                                    ...
                                                    if($div){
                                                        ...
                                                        $div =  new Element('div', {id: 'techNews'});
                                                    }
                                                    var tn = new Element('a', {href: '${portalUrl}techNews/' + (new Date(scheda.techNewsList[0].postDate)).format('%Y/%m/%d/') + scheda.techNewsList[0].tkpost + '?locale=${rc.locale}', 
                                                    target: '_blank'});
                                                    var ico = new Element('img', {src: '<c:url value="/static/images/technews_icon.png"/>', alt: 'tech news'});
                                                    tn.adopt(ico);
                ...
                <div id="art-cnt">
                    ...
                    <div id="art-cnt-dx">
                        <div id="modello" class="dd-scheda det-sel-row clearfix">
                            <security:authorize ifNotGranted="ROLE_ANONYMOUS">
                            <c:if test="${!empty techNewsList}"><div id="techNews" data-tk="${techNewsList[0].tkpost}"><a href="${portalUrl}techNews/<fmt:formatDate value="${techNewsList[0].postDate}" pattern="yyyy/MM/dd/"/>${techNewsList[0].tkpost}?locale=${rc.locale}" target="_blank"><img src="<c:url value="/static/images/technews_icon.png"/>" alt="tech news"/></a></div></c:if>
                            </security:authorize>
                        ...
                        <div id="vetro" class="dd-scheda det-sel-row clearfix">
            ...
            <div class="clearfix" style="clear: both">
                ...
                <div id="articoli-list">
                    ...
                    <c:forEach items="${modellidis}" var="t" varStatus="s">
                        ...
                        <div id="thumb${t.cdvistv1}${t.cdvistv2}${t.cdvistv3}" rel="${famigliaFilter[dsfam]} ${fn:replace(fn:substringBefore(t.vist_filedis, "-"), famigliaFilter.cdvistfam, '')}" class="dis-item<c:if test='${t.cdvistv1==articoli[0].cdvistv1 && t.cdvistv2==articoli[0].cdvistv2 && t.cdvistv3==articoli[0].cdvistv3}'> current</c:if>">
                    ...
                    <script type="text/javascript">
                        ...
                        function iniTipz(cnt){
                            ...
                            //create the tooltips                          
                            cnt.getElements('a.tipz').each(function(element, index) {
                                var offx = Math.round((element.get('title').length*5)/2);
