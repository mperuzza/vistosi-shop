                                ...
                                <tr>
                                    <td>
                                        <div>
                                            ...
                                            <c:if test="${!empty a.vist_articoli_img && a.vist_articoli_img.pathschtecExists}"><a class="${dlink_class}" href="${downloadUrl}fileresources/assembling_instructions/${a.vist_articoli_img.pathschtec}&dsfile=${istrLabel} ${descrFile}" target="_blank"><img src="<c:url value="/static/images/pdf-icon.gif"/>"/></a></c:if> 
