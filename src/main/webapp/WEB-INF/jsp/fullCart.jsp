                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr class="riga"> 
                            ...
                            <security:authorize ifAllGranted="ROLE_ANONYMOUS">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <a class="${dlink_class}" href="${downloadUrlForm}&tipo_richiesta=no_res&file_req=fileresources/assembling_instructions/${namefileReq}&dsfile=${istrLabel} ${descrFile}" target="_blank" title="<spring:message code="msg_file_no_exist" arguments="${istrLabel}" text="Non disponibile. Clicca qui per richiederlo."/>"><img src="<c:url value="/static/images/no-pdf-icon.gif"/>"/></a></c:otherwise> 
                                </c:choose>
                                <c:choose>
                                    <c:when test="${t.articolo.model2D_dwgExists}">
                                    <a class="${dproxylink_class}" href="${downloadUrl}${t.articolo.model2D_dwg}?f=${t.articolo.model2D_dwg}" data-purl="${downloadRequestUrl}&tipo_richiesta=si_res&file_req=${t.articolo.model2D_dwg}&dsfile=${m2DLabel} ${descrFile}" target="_blank" title="<spring:message code="msg_file_exist" arguments="${m2DLabel}" text="Disponibile. Clicca per effettuare il download."/>"><img src="<c:url value="/static/images/dwg-icon.gif"/>"/></a>
                                    </c:when> 
                                    <c:otherwise>
                                    <a class="${dlink_class}" href="${downloadUrlForm}&tipo_richiesta=no_res&file_req=${t.articolo.model2D_dwg}&dsfile=${m2DLabel} ${descrFile}" target="_blank" title="<spring:message code="msg_file_no_exist" arguments="${m2DLabel}" text="Non disponibile. Clicca qui per richiederlo."/>"><img src="<c:url value="/static/images/no-dwg-icon.gif"/>"/></a></c:otherwise> 
                                </c:choose>
                                <c:choose>
                            ...
                            <security:authorize ifNotGranted="ROLE_ANONYMOUS">
                                <c:choose>
                                    <c:when test="${!empty t.articolo.vist_articoli_img && t.articolo.vist_articoli_img.pathschtecExists}"><a class="${dproxylink_class}" href="${downloadUrl}fileresources/assembling_instructions/${t.articolo.vist_articoli_img.pathschtec}?f=fileresources/assembling_instructions/${t.articolo.vist_articoli_img.pathschtec}" data-purl="${downloadRequestUrl}&tipo_richiesta=si_res&file_req=fileresources/assembling_instructions/${t.articolo.vist_articoli_img.pathschtec}&dsfile=${istrLabel} ${descrFile}" target="_blank" title="<spring:message code="msg_file_exist" arguments="${istrLabel}" text="Disponibile. Clicca per effettuare il download."/>"><img src="<c:url value="/static/images/pdf-icon.gif"/>"/></a></c:when> 
                                    <c:otherwise>
                                        <c:set var="namefileReq"><c:choose><c:when test="${!empty t.articolo.vist_articoli_img}">${t.articolo.vist_articoli_img.pathschtec}</c:when><c:otherwise>IM|${t.articolo.cdvisttp}|${t.articolo.cdvistfam}|${t.articolo.cdvistv1}|${t.articolo.cdvistv2}|${t.articolo.cdvistv3}|${t.articolo.cdvistelet}</c:otherwise></c:choose></c:set>
                                    <a class="${drequestlink_class}" href="${downloadRequestUrl}&tipo_richiesta=no_res&file_req=fileresources/assembling_instructions/${namefileReq}&dsfile=${istrLabel} ${descrFile}" target="_blank" title="<spring:message code="msg_file_no_exist" arguments="${istrLabel}" text="Non disponibile. Clicca qui per richiederlo."/>"><img src="<c:url value="/static/images/no-pdf-icon.gif"/>"/></a></c:otherwise> 
                                </c:choose>
                                <c:choose>
                                    <c:when test="${t.articolo.model2D_dwgExists}"><a class="${dproxylink_class}" href="${downloadUrl}${t.articolo.model2D_dwg}?f=${t.articolo.model2D_dwg}" data-purl="${downloadRequestUrl}&tipo_richiesta=si_res&file_req=${t.articolo.model2D_dwg}&dsfile=${m2DLabel} ${descrFile}" target="_blank" title="<spring:message code="msg_file_exist" arguments="${m2DLabel}" text="Disponibile. Clicca per effettuare il download."/>"><img src="<c:url value="/static/images/dwg-icon.gif"/>"/></a></c:when> 
                                    <c:otherwise><a class="${drequestlink_class}" href="${downloadRequestUrl}&tipo_richiesta=no_res&file_req=${t.articolo.model2D_dwg}&dsfile=${m2DLabel} ${descrFile}" target="_blank" title="<spring:message code="msg_file_no_exist" arguments="${m2DLabel}" text="Non disponibile. Clicca qui per richiederlo."/>"><img src="<c:url value="/static/images/no-dwg-icon.gif"/>"/></a></c:otherwise> 
                                </c:choose>
                                <c:choose>
                            ...
                            <security:authorize ifNotGranted="ROLE_ANONYMOUS">
                                <c:choose>
                                    ...
                                    <c:otherwise><a class="${drequestlink_class}" href="${downloadRequestUrl}&tipo_richiesta=no_res&file_req=specsheet/${t.articolo.cdartm}&dsfile=${specSheetLabel} ${descrFile}" target="_blank" title="<spring:message code="msg_file_no_exist" arguments="${specSheetLabel}" text="Non disponibile. Clicca qui per richiederlo."/>"><img src="<c:url value="/static/images/no-tech-icon.gif"/>"/></a></c:otherwise> 
                                </c:choose>                              
                            </security:authorize>
                            <security:authorize ifAllGranted="ROLE_ANONYMOUS">
                                <c:choose>
