                        ...
                        <tr class="riga"> 
                            ...
                            <security:authorize ifAllGranted="ROLE_ANONYMOUS">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <c:set var="namefileReq"><c:choose><c:when test="${!empty t.articolo.vist_articoli_img}">${t.articolo.vist_articoli_img.pathschtec}</c:when><c:otherwise>IM|${t.articolo.cdclas_a}|${t.articolo.cdvisttp}|${t.articolo.cdvistfam}|${t.articolo.cdvistv1}|${t.articolo.cdvistv2}|${t.articolo.cdvistv3}|${t.articolo.cdvistelet}</c:otherwise></c:choose></c:set>
                                        ...
                                        <a class="" href="javascript:void(0)" target="" title="${fn:substringBefore(msgFileNoExist, '.')}"><img src="<c:url value="/static/images/no-pdf-icon.gif"/>"/></a></c:otherwise> 
                                </c:choose>
                                ...
                                <c:choose>
                                    ...
                                    <a class="" href="javascript:void(0)" target="" title="${fn:substringBefore(msgFileNoExist, '.')}"><img src="<c:url value="/static/images/no-dwg-icon.gif"/>"/></a></c:otherwise> 
                                </c:choose>
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                    <%--a class="${dlink_class}" href="${downloadUrlForm}&tipo_richiesta=no_res&file_req=${t.articolo.model3D_easm}&dsfile=${m3DLabel} ${descrFile}${reqDetails}&tiporisorsa=${t.articolo.tiporisorsa3D_easm}" target="_blank" title="<spring:message code="msg_file_no_exist" arguments="${m3DLabel}" text="Non disponibile. Clicca qui per richiederlo."/>"><img src="<c:url value="/static/images/no-easm-icon.gif"/>"/></a--%>
                                    <a class="" href="javascript:void(0)" target="" title="${fn:substringBefore(msgFileNoExist, '.')}"><img src="<c:url value="/static/images/no-easm-icon.gif"/>"/></a>
                                    </c:otherwise> 
                                </c:choose>
                                <%--c:choose>
                            ...
                            <security:authorize ifNotGranted="ROLE_ANONYMOUS">
                                <c:choose>
                                    ...
                                    <%--a class="" href="javascript:void(0)" target="_blank" title="<spring:message code="msg_file_no_exist" arguments="${istrLabel}" text="Non disponibile. Clicca qui per richiederlo."/>"><img src="<c:url value="/static/images/no-pdf-icon.gif"/>"/></a></c:otherwise--%> 
                                </c:choose>
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                    <a class="${drequestlink_class}" href="${downloadRequestUrl}&tipo_richiesta=no_res&file_req=${t.articolo.model2D_dwg}&dsfile=${m2DLabel} ${descrFile}${reqDetails}&tiporisorsa=${t.articolo.tiporisorsa2D_dwg}" target="_blank" title="<spring:message code="msg_file_no_exist" arguments="${m2DLabel}" text="Non disponibile. Clicca qui per richiederlo."/>"><img src="<c:url value="/static/images/no-dwg-icon.gif"/>"/></a>
                                    <%--a class="" href="javascript:void(0)" target="_blank" title="<spring:message code="msg_file_no_exist" arguments="${m2DLabel}" text="Non disponibile. Clicca qui per richiederlo."/>"><img src="<c:url value="/static/images/no-dwg-icon.gif"/>"/></a--%>
                                </c:otherwise> 
                                </c:choose>
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                    <a class="${drequestlink_class}" href="${downloadRequestUrl}&tipo_richiesta=no_res&file_req=${t.articolo.model3D_easm}&dsfile=${m3DLabel} ${descrFile}${reqDetails}&tiporisorsa=${t.articolo.tiporisorsa3D_easm}" target="_blank" title="<spring:message code="msg_file_no_exist" arguments="${m3DLabel}" text="Non disponibile. Clicca qui per richiederlo."/>"><img src="<c:url value="/static/images/no-easm-icon.gif"/>"/></a>
                                    <%--a class="" href="javascript:void(0)" target="_blank" title="<spring:message code="msg_file_no_exist" arguments="${m3DLabel}" text="Non disponibile. Clicca qui per richiederlo."/>"><img src="<c:url value="/static/images/no-easm-icon.gif"/>"/></a--%>
                                </c:otherwise> 
                                </c:choose>
                                <%--c:choose>
